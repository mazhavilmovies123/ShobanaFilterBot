...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
              [
                  InlineKeyboardButton(f'ᴏᴛᴛ ᴜᴘᴅᴀᴛᴇs'​', url='https://t.me/mazhavilMovies_Updates'),
                  InlineKeyboardButton(f'ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ', url='https://t.me/MazhavilMoviesLinks'),
                  InlineKeyboardButton('Bot support group', url='https://t.me/mazhavil_bots')
         ]
            ]
